    """
    Minesweeper Cli Qfz18
    =====================
    Classic guess game reimagined as a single-file Python script.
    ...
    APP_NAME    = "Minesweeper Cli Qfz18"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Classic guess game reimagined as a single-file Python script.")
